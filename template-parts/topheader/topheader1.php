...
<div class="top-header px-5 py-2">
	<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 align-self-center product-search text-right">
                <?php if(class_exists('woocommerce')){ ?>
                    <?php get_product_search_form(); ?>
                <?php }?>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-12 col-12 btn-box align-self-center text-right">
