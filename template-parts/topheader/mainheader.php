...
<div class="main-header text-center text-md-left px-5">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 col-md-4 col-sm-6 col-6 align-self-center">
            ...
            <div class="col-lg-6 col-md-4 col-sm-4 col-4 align-self-center">
                <?php get_template_part('template-parts/navigation/nav'); ?>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-8 col-8 align-self-center text-center text-md-right">
